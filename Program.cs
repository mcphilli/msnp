...
private static bool set_flag_and_number(ref double number_to_set, ref int argct, int argc, String[] argv, double min_v, double max_v, string warning)
    ...
    public class log_fact_table
    {
        ...
        public double log_hyper(int kin_node, int kout_g, int tm, int degree_node) { return log_choose(kout_g, kin_node) + log_choose(tm - kout_g, degree_node - kin_node) - log_choose(tm, degree_node); }
